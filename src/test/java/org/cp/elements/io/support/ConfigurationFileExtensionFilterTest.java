...
/**
 * Test suite of test cases testing the contract and functionality of the {@link ConfigurationFileExtensionFilter} class.
 *
 * @author John J. Blum
 * @see java.io.File
 * @see org.junit.Test
...
public class ConfigurationFileExtensionFilterTest {
  ...
  private ConfigurationFileExtensionFilter fileExtensionFilter = new ConfigurationFileExtensionFilter();
  ...
  public void acceptIsSuccessful() {
    ...
    assertThat(fileExtensions.size(), is(equalTo(ConfigurationFileExtensionFilter.CONFIGURATION_FILE_EXTENSIONS.length)));
    assertThat(fileExtensions.containsAll(Arrays.asList(ConfigurationFileExtensionFilter.CONFIGURATION_FILE_EXTENSIONS)), is(true));
