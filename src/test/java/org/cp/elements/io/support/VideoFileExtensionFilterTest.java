...
/**
 * Test suite of test cases testing the contract and functionality of the {@link VideoFileExtensionFilter} class.
 *
 * @author John J. Blum
 * @see java.io.File
 * @see org.junit.Test
...
public class VideoFileExtensionFilterTest {
  ...
  private VideoFileExtensionFilter fileExtensionFilter = new VideoFileExtensionFilter();
  ...
  public void acceptIsSuccessful() {
    ...
    assertThat(fileExtensions.size(), is(equalTo(VideoFileExtensionFilter.VIDEO_FILE_EXTENSIONS.length)));
    assertThat(fileExtensions.containsAll(Arrays.asList(VideoFileExtensionFilter.VIDEO_FILE_EXTENSIONS)), is(true));
  ...
  public void rejectIsSuccessful() {
    ...
    assertFalse(fileExtensionFilter.accept(newFile("/path/to/video/file.vid")));
