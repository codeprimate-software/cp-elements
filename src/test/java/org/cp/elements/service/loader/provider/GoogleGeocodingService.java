...
/**
 * {@link MockGeocodingService} service provider implementation (SPI) using Google.
 *
 * @author John Blum
 ...
 * @since 1.0.1
 */
@Qualifier(name = "Google")
@SuppressWarnings("unused")
public class GoogleGeocodingService implements MockGeocodingService {
  ...
  public @NotNull String reverseGeocode(@Nullable Point coordinates) {
    return "100 Main St. Portland, OR 97205";
  }
}
