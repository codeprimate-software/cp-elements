...
/**
 * The MergeSortTest class is a test suite of test cases testing the contract and functionality of the MergeSort
 * class and the Merge Sort algorithm.
 *
 * @author John J. Blum
 ...
 * @since 1.0.0
 */
public class MergeSortTest extends CommonSortTestSuite {
