...
/**
 * The InsertionSortTest class is a test suite of test cases testing the contract and functionality of the InsertionSort
 * class and the Insertion Sort algorithm.
 *
 * @author John J. Blum
 ...
 * @since 1.0.0
 */
public class InsertionSortTest extends CommonSortTestSuite {
