...
/**
 * The ReadableFileFilter class is a {@link FileFilter} and {@link Filter} implementation that filters {@link File}s
...
public class ReadableFileFilter implements FileFilter, Filter<File> {

  public static final ReadableFileFilter READABLE_FILES = new ReadableFileFilter(true);
  public static final ReadableFileFilter NON_READABLE_FILES = new ReadableFileFilter(false);

  private final boolean readable;

  /**
   * Constructs an instance of the ReadableFileFilter class initialized with the boolean value indicating whether
   ...
   */
  protected ReadableFileFilter(final boolean readable) {
