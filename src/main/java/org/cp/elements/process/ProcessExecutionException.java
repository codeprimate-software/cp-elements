...
/**
 * The ProcessExecutionException class is a {@link RuntimeException} indicating a problem occurred during
 * the normal execution of a program, either on startup or at runtime, that may or may not have terminated
 * the running {@link Process}.
 *
 * @author John Blum
