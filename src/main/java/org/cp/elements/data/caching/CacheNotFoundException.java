...
/**
 * A {@link RuntimeException} used to indicate a {@link Cache} by {@link String name} could not be found.
 *
 * @author John Blum
...
public class CacheNotFoundException extends CacheException {
  ...
  /**
   * Constructs a new, uninitialized instance of {@link CacheNotFoundException}.
   */
