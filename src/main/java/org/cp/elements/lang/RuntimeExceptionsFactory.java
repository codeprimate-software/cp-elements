 ...
 *
 * This factory class covers the most common {@link RuntimeException RuntimeExceptions}.
 *
 * @author John Blum
...
public abstract class RuntimeExceptionsFactory extends CheckedExceptionsFactory {
  ...
  /*
  public static RuntimeException newRuntimeException(Throwable cause, String message, Object... args) {
    return Optional.ofNullable(cause).map((theCause) -> new RuntimeException(format(message, args), theCause))
