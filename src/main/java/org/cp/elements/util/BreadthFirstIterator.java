...
public class BreadthFirstIterator<T> implements Iterator<T> {
  ...
  /**
   * Determines whether another element is available in this iteration.
   *
   * @return a boolean value indicating whether another element is available in this iteration.
   */
  @Override
