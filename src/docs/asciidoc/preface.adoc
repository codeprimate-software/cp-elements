...
Even the Java platform itself is riddled with many poorly conceived APIs, lacking key functionality that offers
too little value or simply tries to do too much.
